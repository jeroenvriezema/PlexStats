...
<html lang="en">
  <head>
    ...
    <title><?php echo $plexServer->lang()->langinfo->siteTitle." - ".$plexServer->lang()->menu->history; ?></title>
  ...
  <body>
	...
	<div class="container">
		...
		<div class="page-header"><h1><?php echo $plexServer->lang()->menu->history; ?></h1></div>
		<div class="well">
			<?php echo $plexServer->history();?>	
		</div>
	...
	<?php echo $plexServer->tableScript("globalHistory"); ?>
